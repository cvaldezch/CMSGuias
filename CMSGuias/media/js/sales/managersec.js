...
startModidfy = function() {
  ...
  $.post("", data, function(response) {
    var $sel, $tb, att, b, selectBrand, selectModel, template, x;
    if (response.status) {
