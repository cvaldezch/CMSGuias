...
var addMaterial, addMaterialUpdateMeter, aggregateMaterialsOutMeter, aggregate_nipples, approvedAdditional, approvedModify, backModify, backOrders, calMeter, changeRadio, changeRdoNip, changeSelectDeductiveMeter, chkNippChange, clearFieldsDeductiveMeter, copyBack, createTableDeductive, deductiveOneCancel, delMaterials, delPlane, deleteMaterialUpdateMeter, delete_all_temp_nipples, deleteallnipmat, dellAllMaterial, editBrandandModel, editMaterials, generateDeductiveMeter, generateOrders, listMaterials, list_temp_nipples, loadMaterials, loadSecandSub, loadSector, nextOrders, openAddMaterial, openBrand, openModel, panelPlanes, pasteMaterials, saved_or_update_nipples, selectChoiseOrder, showHideTbody, showListNipp, showModify, showOrders, showTablesDeductiveGlobal, show_edit_nipple, showaddtableoutdeductivemeter, startModidfy, updateCommentMat, updateMaterialUpdateMeter, uploadPlane, valMax, valQuantityPreOrders, validBlurNumber, validOrders, viewFull;
...
showTablesDeductiveGlobal = function() {
  var $tnew, tbl, template, x;
  tbl = new Array;
  $("table.table-details > tbody > tr").each(function(index, element) {
    var $td;
    $td = $(element).find("td");
