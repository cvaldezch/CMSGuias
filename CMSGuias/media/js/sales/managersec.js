  ...
  if ($("input[name=mailer-enable]").is(":checked")) {
    ...
    setTimeout(function() {
      ...
      if (globalMailerData.hasOwnProperty("fors")) {
        ...
        return $("select[name=globalmfor]").trigger("chosen:updated");
      }
    }, 200);
  }
};
