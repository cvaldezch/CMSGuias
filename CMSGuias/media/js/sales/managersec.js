...
var addMaterial, addMaterialUpdateMeter, aggregateMaterialsOutMeter, aggregate_nipples, approvedAdditional, approvedModify, backModify, backOrders, calMeter, changeRadio, changeRdoNip, changeSelectDeductiveMeter, chkNippChange, clearFieldsDeductiveMeter, copyBack, createTableDeductive, deductiveOneCancel, delMaterials, delPlane, deleteMaterialUpdateMeter, delete_all_temp_nipples, deleteallnipmat, dellAllMaterial, displayResultTable, editBrandandModel, editMaterials, generateDeductiveMeter, generateOrders, listMaterials, list_temp_nipples, loadMaterials, loadSecandSub, loadSector, nextOrders, openAddMaterial, openBrand, openModel, panelPlanes, pasteMaterials, saved_or_update_nipples, searchDescDeductiveGlobal, selectChoiseOrder, showHideTbody, showInitDeductive, showListNipp, showModify, showOrders, showPanelAddMateialsOldDeductiveGlobal, show_edit_nipple, showaddtableoutdeductivemeter, startModidfy, updateCommentMat, updateMaterialUpdateMeter, uploadPlane, valMax, valQuantityPreOrders, validBlurNumber, validOrders, viewFull;
