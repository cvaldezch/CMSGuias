...
showAlertStartProject = (event) ->
    ...
    <p><span style=\"font-size: 10pt;\" data-mce-style=\"font-size: 10pt;\">Estimados,</span></p><p style=\"text-align: justify;\" data-mce-style=\"text-align: justify;\"><span style=\"font-size: 10pt;\" data-mce-style=\"font-size: 10pt;\">Para hacerles de su conocimiento que hoy #{new Date().toLocaleDateString() } se realiza la apertura del proyecto <strong>\"#{$pro.attr "data-name"}\"</strong>  con código <strong>\"#{$pro.val()}\"</strong> que se realizara en \"#{$pro.attr "data-address"}\" para el cliente <strong>\"#{$pro.attr "data-customers"}\"</strong>. El proyecto tendrá como fecha de inicio #{$pro.attr "data-star"} y un fecha de termino aproximada para el #{$pro.attr "data-end"}.</span></p><p><span style=\"font-size: 10pt;\" data-mce-style=\"font-size: 10pt;\"><strong>Operaciones</strong> : #{ $pro.attr "data-responsible" }</span></p><p><span style=\"font-size: 10pt;\" data-mce-style=\"font-size: 10pt;\"><br data-mce-bogus=\"1\"></span></p><p><span style=\"font-size: 10pt;\" data-mce-style=\"font-size: 10pt;\">Saludos.</span></p><p><span style=\"font-size: 10pt;\" data-mce-style=\"font-size: 10pt;\"><strong> #{ $("input[name=user-email]").attr("data-name") }</strong></span><br /><span style=\"font-size: 10pt;\" data-mce-style=\"font-size: 10pt;\"><strong>#{$("input[name=companyname]").val()}</strong></span><br></p><p><span style=\"font-size: 10pt;\" data-mce-style=\"font-size: 10pt;\"><strong>Telf:</strong> #{$("input[name=companyname]").attr("data-phone")}</span></p><p><br data-mce-bogus=\"1\"></p>
    "
    setTimeout ->
        showGlobalEnvelop()
    , 800
