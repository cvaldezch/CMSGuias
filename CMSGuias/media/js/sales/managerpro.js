...
var addDetailsPurchase, approvedProject, assignedResponsible, calAmountPurchaseOrder, changeView, deleteDetailsPurchase, deleteOrderPurchase, deleteSubproject, fileTree, getAmountLiteral, getEditPurchase, getListPurchaseOrder, getPercentIVA, getSectors, openNewSector, openNewSubproyecto, openUpdateSector, openUpdateSubproject, openWindow, publisherCommnet, savePurchaseOrder, setSubproject, showAlertStartProject, showEditComment, showEditDetailsPurchase, toggleComment, treeAdminaandOpera, uploadFiles;
  ...
  if ((responsible != null) && (admin != null) && (passwd != null)) {
    ...
    $.post("", data, function(response) {
      if (response.status) {
        ...
        return $().toastmessage("showErrorToast", "Transaccion error: " + response.raise);
      }
    });
    return;
  }
