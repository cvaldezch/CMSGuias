...
loadDocumentsClosure = function(event) {
  var $doc, data, i, _i, _ref;
  $doc = $("[name=documentsclosure]").get(0).files;
  if ($doc.length) {
    data = new FormData;
    if ($doc.length > 1) {
      for (i = _i = 0, _ref = $doc.length; _i < _ref; i = _i += 1) {
