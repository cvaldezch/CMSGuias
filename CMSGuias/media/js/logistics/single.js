...
(function() {
  var addTmpQuote, changeRadio, deleteAll, deleteMaterial, editMaterial, keyCode, keyDescription, listTmpQuote, loadStore, loadSupplier, loadText, saveQuote, searchMaterial, showEdit, showMaterials, stepSecond, uploadReadFile;
  ...
  saveQuote = function(event) {
    var check, data, obser, store, supplier, transfer;
