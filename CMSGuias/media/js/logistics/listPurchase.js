...
var SavePurchase, addNewMaterialPurchase, calcAmount, changeSearch, changeSelect, deleCheckMaterials, getDataPurchase, getSearch, listDetails, openWindow, saveEditDetailsPurchase, showActions, showChoiceDeposit, showEditDetailsPurchase, showEditPurchasae, showPanelAdd, showStepOne;
...
showChoiceDeposit = function(event) {
  return $("input[name=deposit]").click();
};
