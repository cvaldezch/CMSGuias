...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Configuracion.perception'
        db.add_column(u'home_configuracion', 'perception',
                      self.gf('django.db.models.fields.FloatField')(default=2),
                      keep_default=False)


        # Changing field 'Configuracion.igv'
        db.alter_column(u'home_configuracion', 'igv', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):
        # Deleting field 'Configuracion.perception'
        db.delete_column(u'home_configuracion', 'perception')


        # Changing field 'Configuracion.igv'
        db.alter_column(u'home_configuracion', 'igv', self.gf('django.db.models.fields.IntegerField')())
