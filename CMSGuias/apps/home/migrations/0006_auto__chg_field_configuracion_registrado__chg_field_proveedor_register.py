...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Configuracion.registrado'
        db.alter_column(u'home_configuracion', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Proveedor.register'
        db.alter_column(u'home_proveedor', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True))

        # Changing field 'TipoCambio.registrado'
        db.alter_column(u'home_tipocambio', 'registrado', self.gf('django.db.models.fields.TimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Configuracion.registrado'
        db.alter_column(u'home_configuracion', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Proveedor.register'
        db.alter_column(u'home_proveedor', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

        # Changing field 'TipoCambio.registrado'
        db.alter_column(u'home_tipocambio', 'registrado', self.gf('django.db.models.fields.TimeField')(auto_now=True))
