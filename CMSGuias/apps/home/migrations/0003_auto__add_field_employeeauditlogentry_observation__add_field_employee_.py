...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeAuditLogEntry.observation'
        db.add_column(u'home_employeeauditlogentry', 'observation',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.observation'
        db.add_column(u'home_employee', 'observation',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmployeeAuditLogEntry.observation'
        db.delete_column(u'home_employeeauditlogentry', 'observation')

        # Deleting field 'Employee.observation'
        db.delete_column(u'home_employee', 'observation')
    ...
    models = {
        ...
        u'home.employee': {
            ...
            'phonejob': ('django.db.models.fields.CharField', [], {'max_length': '27', 'null': 'True', 'blank': 'True'}),
