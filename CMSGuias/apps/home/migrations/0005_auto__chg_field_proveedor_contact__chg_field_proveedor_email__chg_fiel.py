...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proveedor.contact'
        db.alter_column(u'home_proveedor', 'contact', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Proveedor.email'
        db.alter_column(u'home_proveedor', 'email', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'EmployeeAuditLogEntry.phonejob'
        db.alter_column(u'home_employeeauditlogentry', 'phonejob', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'EmployeeAuditLogEntry.phone'
        db.alter_column(u'home_employeeauditlogentry', 'phone', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Employee.phonejob'
        db.alter_column(u'home_employee', 'phonejob', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Employee.phone'
        db.alter_column(u'home_employee', 'phone', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # Changing field 'Proveedor.contact'
        db.alter_column(u'home_proveedor', 'contact', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Proveedor.email'
        db.alter_column(u'home_proveedor', 'email', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'EmployeeAuditLogEntry.phonejob'
        db.alter_column(u'home_employeeauditlogentry', 'phonejob', self.gf('django.db.models.fields.CharField')(max_length=27, null=True))

        # Changing field 'EmployeeAuditLogEntry.phone'
        db.alter_column(u'home_employeeauditlogentry', 'phone', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Employee.phonejob'
        db.alter_column(u'home_employee', 'phonejob', self.gf('django.db.models.fields.CharField')(max_length=27, null=True))

        # Changing field 'Employee.phone'
        db.alter_column(u'home_employee', 'phone', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
