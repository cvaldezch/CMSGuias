...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeAuditLogEntry.email'
        db.add_column(u'home_employeeauditlogentry', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=80, null=True, blank=True),
                      keep_default=False)
        ...
        db.add_column(u'home_employee', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=80, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'EmployeeAuditLogEntry.email'
        db.delete_column(u'home_employeeauditlogentry', 'email')
        ...
        db.delete_column(u'home_employee', 'email')
