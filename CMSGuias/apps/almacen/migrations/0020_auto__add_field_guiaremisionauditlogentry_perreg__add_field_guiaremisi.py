...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GuiaRemisionAuditLogEntry.perreg'
        db.add_column(u'almacen_guiaremisionauditlogentry', 'perreg',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'GuiaRemision.perreg'
        db.add_column(u'almacen_guiaremision', 'perreg',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GuiaRemisionAuditLogEntry.perreg'
        db.delete_column(u'almacen_guiaremisionauditlogentry', 'perreg_id')

        # Deleting field 'GuiaRemision.perreg'
        db.delete_column(u'almacen_guiaremision', 'perreg_id')
