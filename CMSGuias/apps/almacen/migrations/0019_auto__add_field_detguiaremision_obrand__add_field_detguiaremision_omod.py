...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetGuiaRemision.obrand'
        db.add_column(u'almacen_detguiaremision', 'obrand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', related_name='obrandAsDetGuide', blank=True, to=orm['home.Brand']),
                      keep_default=False)

        # Adding field 'DetGuiaRemision.omodel'
        db.add_column(u'almacen_detguiaremision', 'omodel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='MO000', related_name='omodelAsDetGuide', blank=True, to=orm['home.Model']),
                      keep_default=False)

        # Adding field 'DetGuiaRemisionAuditLogEntry.obrand'
        db.add_column(u'almacen_detguiaremisionauditlogentry', 'obrand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', related_name=u'_auditlog_obrandAsDetGuide', blank=True, to=orm['home.Brand']),
                      keep_default=False)

        # Adding field 'DetGuiaRemisionAuditLogEntry.omodel'
        db.add_column(u'almacen_detguiaremisionauditlogentry', 'omodel',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='MO000', related_name=u'_auditlog_omodelAsDetGuide', blank=True, to=orm['home.Model']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetGuiaRemision.obrand'
        db.delete_column(u'almacen_detguiaremision', 'obrand_id')

        # Deleting field 'DetGuiaRemision.omodel'
        db.delete_column(u'almacen_detguiaremision', 'omodel_id')

        # Deleting field 'DetGuiaRemisionAuditLogEntry.obrand'
        db.delete_column(u'almacen_detguiaremisionauditlogentry', 'obrand_id')

        # Deleting field 'DetGuiaRemisionAuditLogEntry.omodel'
        db.delete_column(u'almacen_detguiaremisionauditlogentry', 'omodel_id')
