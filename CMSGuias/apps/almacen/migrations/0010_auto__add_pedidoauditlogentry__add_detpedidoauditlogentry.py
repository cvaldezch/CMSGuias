...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PedidoAuditLogEntry'
        db.create_table(u'almacen_pedidoauditlogentry', (
            ('pedido_id', self.gf('django.db.models.fields.CharField')(default='PEAA000000', max_length=10, db_index=True)),
            ...
            ('dsector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.DSector'], null=True, blank=True)),
            ...
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_pedido_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'almacen', ['PedidoAuditLogEntry'])

        # Adding model 'DetpedidoAuditLogEntry'
        db.create_table(u'almacen_detpedidoauditlogentry', (
            ...
            ('comment', self.gf('django.db.models.fields.CharField')(default='', max_length=250, null=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_detpedido_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['DetpedidoAuditLogEntry'])


    def backwards(self, orm):
        # Deleting model 'PedidoAuditLogEntry'
        db.delete_table(u'almacen_pedidoauditlogentry')

        # Deleting model 'DetpedidoAuditLogEntry'
        db.delete_table(u'almacen_detpedidoauditlogentry')
