...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NipleAuditLogEntry'
        db.create_table(u'almacen_nipleauditlogentry', (
            ...
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_niple_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'almacen', ['NipleAuditLogEntry'])


    def backwards(self, orm):
        # Deleting model 'NipleAuditLogEntry'
        db.delete_table(u'almacen_nipleauditlogentry')
