...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'tmpniple.brand'
        db.add_column(u'almacen_tmpniple', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', to=orm['home.Brand'], blank=True),
                      keep_default=False)

        # Adding field 'tmpniple.model'
        db.add_column(u'almacen_tmpniple', 'model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='MO000', to=orm['home.Model'], blank=True),
                      keep_default=False)

        # Adding field 'Niple.brand'
        db.add_column(u'almacen_niple', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', to=orm['home.Brand'], blank=True),
                      keep_default=False)

        # Adding field 'Niple.model'
        db.add_column(u'almacen_niple', 'model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='MO000', to=orm['home.Model'], blank=True),
                      keep_default=False)

        # Adding field 'NipleGuiaRemision.brand'
        db.add_column(u'almacen_nipleguiaremision', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', to=orm['home.Brand'], blank=True),
                      keep_default=False)

        # Adding field 'NipleGuiaRemision.model'
        db.add_column(u'almacen_nipleguiaremision', 'model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='MO000', to=orm['home.Model'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'tmpniple.brand'
        db.delete_column(u'almacen_tmpniple', 'brand_id')

        # Deleting field 'tmpniple.model'
        db.delete_column(u'almacen_tmpniple', 'model_id')

        # Deleting field 'Niple.brand'
        db.delete_column(u'almacen_niple', 'brand_id')

        # Deleting field 'Niple.model'
        db.delete_column(u'almacen_niple', 'model_id')

        # Deleting field 'NipleGuiaRemision.brand'
        db.delete_column(u'almacen_nipleguiaremision', 'brand_id')

        # Deleting field 'NipleGuiaRemision.model'
        db.delete_column(u'almacen_nipleguiaremision', 'model_id')
