...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Restoration.ndocument'
        db.delete_column(u'almacen_restoration', 'ndocument_id')

        # Adding field 'Restoration.guideout'
        db.add_column(u'almacen_restoration', 'guideout',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='guideoutAsGuide', null=True, to=orm['almacen.GuiaRemision']),
                      keep_default=False)

        # Adding field 'Restoration.guidein'
        db.add_column(u'almacen_restoration', 'guidein',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='guideinGuide', null=True, to=orm['almacen.GuiaRemision']),
                      keep_default=False)

        # Adding field 'Restoration.project'
        db.add_column(u'almacen_restoration', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'], null=True),
                      keep_default=False)

        # Adding field 'Restoration.sector'
        db.add_column(u'almacen_restoration', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True),
                      keep_default=False)

        # Adding field 'Restoration.dsector_id'
        db.add_column(u'almacen_restoration', 'dsector_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.DSector'], null=True),
                      keep_default=False)

        # Adding field 'Restoration.status'
        db.add_column(u'almacen_restoration', 'status',
                      self.gf('django.db.models.fields.CharField')(default='AC', max_length=2),
                      keep_default=False)


        # Changing field 'Restoration.restoration_id'
        db.alter_column(u'almacen_restoration', 'restoration_id', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True))
        # Deleting field 'RestorationAuditLogEntry.ndocument'
        db.delete_column(u'almacen_restorationauditlogentry', 'ndocument_id')

        # Adding field 'RestorationAuditLogEntry.guideout'
        db.add_column(u'almacen_restorationauditlogentry', 'guideout',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'_auditlog_guideoutAsGuide', null=True, to=orm['almacen.GuiaRemision']),
                      keep_default=False)

        # Adding field 'RestorationAuditLogEntry.guidein'
        db.add_column(u'almacen_restorationauditlogentry', 'guidein',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'_auditlog_guideinGuide', null=True, to=orm['almacen.GuiaRemision']),
                      keep_default=False)

        # Adding field 'RestorationAuditLogEntry.project'
        db.add_column(u'almacen_restorationauditlogentry', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'], null=True),
                      keep_default=False)

        # Adding field 'RestorationAuditLogEntry.sector'
        db.add_column(u'almacen_restorationauditlogentry', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True),
                      keep_default=False)

        # Adding field 'RestorationAuditLogEntry.dsector_id'
        db.add_column(u'almacen_restorationauditlogentry', 'dsector_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.DSector'], null=True),
                      keep_default=False)

        # Adding field 'RestorationAuditLogEntry.status'
        db.add_column(u'almacen_restorationauditlogentry', 'status',
                      self.gf('django.db.models.fields.CharField')(default='AC', max_length=2),
                      keep_default=False)


        # Changing field 'RestorationAuditLogEntry.restoration_id'
        db.alter_column(u'almacen_restorationauditlogentry', 'restoration_id', self.gf('django.db.models.fields.CharField')(max_length=8))
        # Adding field 'DetRestoration.niple'
        db.add_column(u'almacen_detrestoration', 'niple',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetRestoration.other'
        db.add_column(u'almacen_detrestoration', 'other',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Restoration.ndocument'
        db.add_column(u'almacen_restoration', 'ndocument',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['almacen.GuiaRemision']),
                      keep_default=False)

        # Deleting field 'Restoration.guideout'
        db.delete_column(u'almacen_restoration', 'guideout_id')

        # Deleting field 'Restoration.guidein'
        db.delete_column(u'almacen_restoration', 'guidein_id')

        # Deleting field 'Restoration.project'
        db.delete_column(u'almacen_restoration', 'project_id')

        # Deleting field 'Restoration.sector'
        db.delete_column(u'almacen_restoration', 'sector_id')

        # Deleting field 'Restoration.dsector_id'
        db.delete_column(u'almacen_restoration', 'dsector_id_id')

        # Deleting field 'Restoration.status'
        db.delete_column(u'almacen_restoration', 'status')


        # Changing field 'Restoration.restoration_id'
        db.alter_column(u'almacen_restoration', 'restoration_id', self.gf('django.db.models.fields.CharField')(max_length=6, primary_key=True))
        # Adding field 'RestorationAuditLogEntry.ndocument'
        db.add_column(u'almacen_restorationauditlogentry', 'ndocument',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['almacen.GuiaRemision']),
                      keep_default=False)

        # Deleting field 'RestorationAuditLogEntry.guideout'
        db.delete_column(u'almacen_restorationauditlogentry', 'guideout_id')

        # Deleting field 'RestorationAuditLogEntry.guidein'
        db.delete_column(u'almacen_restorationauditlogentry', 'guidein_id')

        # Deleting field 'RestorationAuditLogEntry.project'
        db.delete_column(u'almacen_restorationauditlogentry', 'project_id')

        # Deleting field 'RestorationAuditLogEntry.sector'
        db.delete_column(u'almacen_restorationauditlogentry', 'sector_id')

        # Deleting field 'RestorationAuditLogEntry.dsector_id'
        db.delete_column(u'almacen_restorationauditlogentry', 'dsector_id_id')

        # Deleting field 'RestorationAuditLogEntry.status'
        db.delete_column(u'almacen_restorationauditlogentry', 'status')


        # Changing field 'RestorationAuditLogEntry.restoration_id'
        db.alter_column(u'almacen_restorationauditlogentry', 'restoration_id', self.gf('django.db.models.fields.CharField')(max_length=6))
        # Deleting field 'DetRestoration.niple'
        db.delete_column(u'almacen_detrestoration', 'niple')

        # Deleting field 'DetRestoration.other'
        db.delete_column(u'almacen_detrestoration', 'other')
