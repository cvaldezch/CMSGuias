...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DetGuiaRemision.brand'
        db.alter_column(u'almacen_detguiaremision', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand']))

        # Changing field 'DetGuiaRemision.model'
        db.alter_column(u'almacen_detguiaremision', 'model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Model']))

        # Changing field 'DetGuiaRemisionAuditLogEntry.brand'
        db.alter_column(u'almacen_detguiaremisionauditlogentry', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand']))

        # Changing field 'DetGuiaRemisionAuditLogEntry.model'
        db.alter_column(u'almacen_detguiaremisionauditlogentry', 'model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Model']))

    def backwards(self, orm):

        # Changing field 'DetGuiaRemision.brand'
        db.alter_column(u'almacen_detguiaremision', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand'], null=True))

        # Changing field 'DetGuiaRemision.model'
        db.alter_column(u'almacen_detguiaremision', 'model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Model'], null=True))

        # Changing field 'DetGuiaRemisionAuditLogEntry.brand'
        db.alter_column(u'almacen_detguiaremisionauditlogentry', 'brand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand'], null=True))

        # Changing field 'DetGuiaRemisionAuditLogEntry.model'
        db.alter_column(u'almacen_detguiaremisionauditlogentry', 'model_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Model'], null=True))
