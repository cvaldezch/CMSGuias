...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetGuiaRemision.order'
        db.add_column(u'almacen_detguiaremision', 'order',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetGuiaRemisionAuditLogEntry.order'
        db.add_column(u'almacen_detguiaremisionauditlogentry', 'order',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GuiaRemisionAuditLogEntry.orders'
        db.add_column(u'almacen_guiaremisionauditlogentry', 'orders',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GuiaRemision.orders'
        db.add_column(u'almacen_guiaremision', 'orders',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetGuiaRemision.order'
        db.delete_column(u'almacen_detguiaremision', 'order')

        # Deleting field 'DetGuiaRemisionAuditLogEntry.order'
        db.delete_column(u'almacen_detguiaremisionauditlogentry', 'order')

        # Deleting field 'GuiaRemisionAuditLogEntry.orders'
        db.delete_column(u'almacen_guiaremisionauditlogentry', 'orders')

        # Deleting field 'GuiaRemision.orders'
        db.delete_column(u'almacen_guiaremision', 'orders')
    ...
    models = {
        u'almacen.detguiaremision': {
            ...
            'order': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'})
        },
