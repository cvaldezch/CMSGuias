...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Detpedido.comment'
        db.alter_column(u'almacen_detpedido', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Detpedido.comment'
        db.alter_column(u'almacen_detpedido', 'comment', self.gf('django.db.models.fields.CharField')(max_length=250))
