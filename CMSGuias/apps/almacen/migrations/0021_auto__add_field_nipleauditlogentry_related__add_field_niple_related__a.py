...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NipleAuditLogEntry.related'
        db.add_column(u'almacen_nipleauditlogentry', 'related',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Niple.related'
        db.add_column(u'almacen_niple', 'related',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'NipleGuiaRemision.related'
        db.add_column(u'almacen_nipleguiaremision', 'related',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NipleAuditLogEntry.related'
        db.delete_column(u'almacen_nipleauditlogentry', 'related')

        # Deleting field 'Niple.related'
        db.delete_column(u'almacen_niple', 'related')

        # Deleting field 'NipleGuiaRemision.related'
        db.delete_column(u'almacen_nipleguiaremision', 'related')
