...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NipleGuiaRemision.order'
        db.add_column(u'almacen_nipleguiaremision', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NipleGuiaRemision.order'
        db.delete_column(u'almacen_nipleguiaremision', 'order_id')
