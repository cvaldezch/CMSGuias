...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetIngress.purchase'
        db.add_column(u'almacen_detingress', 'purchase',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DetIngress.sales'
        db.add_column(u'almacen_detingress', 'sales',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DetIngressAuditLogEntry.purchase'
        db.add_column(u'almacen_detingressauditlogentry', 'purchase',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DetIngressAuditLogEntry.sales'
        db.add_column(u'almacen_detingressauditlogentry', 'sales',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetIngress.purchase'
        db.delete_column(u'almacen_detingress', 'purchase')

        # Deleting field 'DetIngress.sales'
        db.delete_column(u'almacen_detingress', 'sales')

        # Deleting field 'DetIngressAuditLogEntry.purchase'
        db.delete_column(u'almacen_detingressauditlogentry', 'purchase')

        # Deleting field 'DetIngressAuditLogEntry.sales'
        db.delete_column(u'almacen_detingressauditlogentry', 'sales')
