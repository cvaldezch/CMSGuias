...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pedido.registrado'
        db.alter_column(u'almacen_pedido', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'GuiaRemision.registrado'
        db.alter_column(u'almacen_guiaremision', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'GuiaRemision.pedido'
        db.alter_column(u'almacen_guiaremision', 'pedido_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True))

        # Changing field 'ReportInspect.register'
        db.alter_column(u'almacen_reportinspect', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Suministro.registrado'
        db.alter_column(u'almacen_suministro', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Pedido.registrado'
        db.alter_column(u'almacen_pedido', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'GuiaRemision.registrado'
        db.alter_column(u'almacen_guiaremision', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'GuiaRemision.pedido'
        db.alter_column(u'almacen_guiaremision', 'pedido_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['almacen.Pedido']))

        # Changing field 'ReportInspect.register'
        db.alter_column(u'almacen_reportinspect', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Suministro.registrado'
        db.alter_column(u'almacen_suministro', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
