...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InventarioAuditLogEntry'
        db.create_table(u'almacen_inventarioauditlogentry', (
            ...
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_inventario_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'almacen', ['InventarioAuditLogEntry'])

        # Adding model 'InventoryBrandAuditLogEntry'
        db.create_table(u'almacen_inventorybrandauditlogentry', (
            (u'id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ...
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_inventorybrand_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['InventoryBrandAuditLogEntry'])

        # Adding model 'DetIngressAuditLogEntry'
        db.create_table(u'almacen_detingressauditlogentry', (
            (u'id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ...
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_detingress_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['DetIngressAuditLogEntry'])

        # Adding model 'Restoration'
        db.create_table(u'almacen_restoration', (
            ('restoration_id', self.gf('django.db.models.fields.CharField')(max_length=6, primary_key=True)),
            ('almacen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Almacene'])),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ndocument', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaRemision'])),
            ('observation', self.gf('django.db.models.fields.TextField')()),
            ('performed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'])),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'almacen', ['Restoration'])

        # Adding model 'NoteIngressAuditLogEntry'
        db.create_table(u'almacen_noteingressauditlogentry', (
            ('ingress_id', self.gf('django.db.models.fields.CharField')(max_length=10, db_index=True)),
            ('storage', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Almacene'])),
            ...
            ('receive', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_receiveAsEmployee', to=orm['home.Employee'])),
            ('inspection', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_inspectionAsEmployee', to=orm['home.Employee'])),
            ('approval', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_approvalAsEmployee', to=orm['home.Employee'])),
            ...
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_noteingress_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['NoteIngressAuditLogEntry'])

        # Adding model 'DetGuiaRemisionAuditLogEntry'
        db.create_table(u'almacen_detguiaremisionauditlogentry', (
            (u'id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ...
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand'], null=True, blank=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Model'], null=True, blank=True)),
            ('observation', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_detguiaremision_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['DetGuiaRemisionAuditLogEntry'])

        # Adding model 'GuiaRemisionAuditLogEntry'
        db.create_table(u'almacen_guiaremisionauditlogentry', (
            ('guia_id', self.gf('django.db.models.fields.CharField')(max_length=12, db_index=True)),
            ('pedido', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True, blank=True)),
            ...
            ('motive', self.gf('django.db.models.fields.CharField')(default='VENTA', max_length=160, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')(default='')),
            ('observation', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('nota', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('dotoutput', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_guiaremision_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['GuiaRemisionAuditLogEntry'])

        # Adding model 'RestorationAuditLogEntry'
        db.create_table(u'almacen_restorationauditlogentry', (
            ('restoration_id', self.gf('django.db.models.fields.CharField')(max_length=6, db_index=True)),
            ('almacen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Almacene'])),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ndocument', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaRemision'])),
            ('observation', self.gf('django.db.models.fields.TextField')()),
            ('performed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'])),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_restoration_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['RestorationAuditLogEntry'])

        # Adding model 'DetRestoration'
        db.create_table(u'almacen_detrestoration', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('restoration', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Restoration'])),
            ('materials', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand'])),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Model'])),
            ('quantity', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'almacen', ['DetRestoration'])


    def backwards(self, orm):
        # Deleting model 'InventarioAuditLogEntry'
        db.delete_table(u'almacen_inventarioauditlogentry')

        # Deleting model 'InventoryBrandAuditLogEntry'
        db.delete_table(u'almacen_inventorybrandauditlogentry')

        # Deleting model 'DetIngressAuditLogEntry'
        db.delete_table(u'almacen_detingressauditlogentry')

        # Deleting model 'Restoration'
        db.delete_table(u'almacen_restoration')

        # Deleting model 'NoteIngressAuditLogEntry'
        db.delete_table(u'almacen_noteingressauditlogentry')

        # Deleting model 'DetGuiaRemisionAuditLogEntry'
        db.delete_table(u'almacen_detguiaremisionauditlogentry')

        # Deleting model 'GuiaRemisionAuditLogEntry'
        db.delete_table(u'almacen_guiaremisionauditlogentry')

        # Deleting model 'RestorationAuditLogEntry'
        db.delete_table(u'almacen_restorationauditlogentry')

        # Deleting model 'DetRestoration'
        db.delete_table(u'almacen_detrestoration')
    ...
    models = {
        u'almacen.detguiaremision': {
            ...
            'model': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Model']", 'null': 'True', 'blank': 'True'}),
        ...
        u'almacen.guiaremision': {
            ...
            'motive': ('django.db.models.fields.CharField', [], {'default': "'VENTA'", 'max_length': '160', 'blank': 'True'}),
