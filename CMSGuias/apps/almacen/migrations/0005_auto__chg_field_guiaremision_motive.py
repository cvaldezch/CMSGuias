...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GuiaRemision.motive'
        db.alter_column(u'almacen_guiaremision', 'motive', self.gf('django.db.models.fields.CharField')(max_length=160))

    def backwards(self, orm):

        # Changing field 'GuiaRemision.motive'
        db.alter_column(u'almacen_guiaremision', 'motive', self.gf('django.db.models.fields.CharField')(max_length=2))
