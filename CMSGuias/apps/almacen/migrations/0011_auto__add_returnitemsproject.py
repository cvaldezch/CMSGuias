...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReturnItemsProject'
        db.create_table(u'almacen_returnitemsproject', (
            ...
            ('listsend', self.gf('django.db.models.fields.TextField')()),
            ('notpro', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'almacen', ['ReturnItemsProject'])


    def backwards(self, orm):
        # Deleting model 'ReturnItemsProject'
        db.delete_table(u'almacen_returnitemsproject')
