...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TmpDetGuia'
        db.create_table(u'almacen_tmpdetguia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('materials', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
            ('quantity', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
        ...
        db.send_create_signal(u'almacen', ['TmpDetGuia'])

        # Adding field 'GuiaRemision.observation'
        db.add_column(u'almacen_guiaremision', 'observation',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GuiaRemision.nota'
        db.add_column(u'almacen_guiaremision', 'nota',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GuiaRemision.dotoutput'
        db.add_column(u'almacen_guiaremision', 'dotoutput',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetGuiaRemision.brand'
        db.add_column(u'almacen_detguiaremision', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetGuiaRemision.model'
        db.add_column(u'almacen_detguiaremision', 'model',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Model'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DetGuiaRemision.observation'
        db.add_column(u'almacen_detguiaremision', 'observation',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'TmpDetGuia'
        db.delete_table(u'almacen_tmpdetguia')

        # Deleting field 'GuiaRemision.observation'
        db.delete_column(u'almacen_guiaremision', 'observation')

        # Deleting field 'GuiaRemision.nota'
        db.delete_column(u'almacen_guiaremision', 'nota')

        # Deleting field 'GuiaRemision.dotoutput'
        db.delete_column(u'almacen_guiaremision', 'dotoutput')

        # Deleting field 'DetGuiaRemision.brand'
        db.delete_column(u'almacen_detguiaremision', 'brand_id')

        # Deleting field 'DetGuiaRemision.model'
        db.delete_column(u'almacen_detguiaremision', 'model_id')

        # Deleting field 'DetGuiaRemision.observation'
        db.delete_column(u'almacen_detguiaremision', 'observation')
