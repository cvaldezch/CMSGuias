...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BalanceAuditLogEntry'
        db.create_table(u'almacen_balanceauditlogentry', (
            ...
            ('storage', self.gf('django.db.models.fields.related.ForeignKey')(default='AL01', to=orm['home.Almacene'], blank=True)),
            ...
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_balance_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'almacen', ['BalanceAuditLogEntry'])


        # Renaming column for 'DetGuiaRemision.order' to match new field type.
        db.rename_column(u'almacen_detguiaremision', 'order', 'order_id')
        # Changing field 'DetGuiaRemision.order'
        db.alter_column(u'almacen_detguiaremision', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True))
        # Adding index on 'DetGuiaRemision', fields ['order']
        db.create_index(u'almacen_detguiaremision', ['order_id'])


        # Renaming column for 'DetGuiaRemisionAuditLogEntry.order' to match new field type.
        db.rename_column(u'almacen_detguiaremisionauditlogentry', 'order', 'order_id')
        # Changing field 'DetGuiaRemisionAuditLogEntry.order'
        db.alter_column(u'almacen_detguiaremisionauditlogentry', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True))
        # Adding index on 'DetGuiaRemisionAuditLogEntry', fields ['order']
        db.create_index(u'almacen_detguiaremisionauditlogentry', ['order_id'])


    def backwards(self, orm):
        # Removing index on 'DetGuiaRemisionAuditLogEntry', fields ['order']
        db.delete_index(u'almacen_detguiaremisionauditlogentry', ['order_id'])

        # Removing index on 'DetGuiaRemision', fields ['order']
        db.delete_index(u'almacen_detguiaremision', ['order_id'])

        # Deleting model 'BalanceAuditLogEntry'
        db.delete_table(u'almacen_balanceauditlogentry')


        # Renaming column for 'DetGuiaRemision.order' to match new field type.
        db.rename_column(u'almacen_detguiaremision', 'order_id', 'order')
        # Changing field 'DetGuiaRemision.order'
        db.alter_column(u'almacen_detguiaremision', 'order', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Renaming column for 'DetGuiaRemisionAuditLogEntry.order' to match new field type.
        db.rename_column(u'almacen_detguiaremisionauditlogentry', 'order_id', 'order')
        # Changing field 'DetGuiaRemisionAuditLogEntry.order'
        db.alter_column(u'almacen_detguiaremisionauditlogentry', 'order', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
