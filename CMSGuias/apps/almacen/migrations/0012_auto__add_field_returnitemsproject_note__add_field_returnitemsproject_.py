...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReturnItemsProject.note'
        db.add_column(u'almacen_returnitemsproject', 'note',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ReturnItemsProject.status'
        db.add_column(u'almacen_returnitemsproject', 'status',
                      self.gf('django.db.models.fields.CharField')(default='AC', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReturnItemsProject.note'
        db.delete_column(u'almacen_returnitemsproject', 'note')

        # Deleting field 'ReturnItemsProject.status'
        db.delete_column(u'almacen_returnitemsproject', 'status')
