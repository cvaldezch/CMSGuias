...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SGroup.status'
        db.add_column(u'operations_sgroup', 'status',
                      self.gf('django.db.models.fields.CharField')(default='PE', max_length=2),
                      keep_default=False)

        # Adding field 'SGroupAuditLogEntry.status'
        db.add_column(u'operations_sgroupauditlogentry', 'status',
                      self.gf('django.db.models.fields.CharField')(default='PE', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SGroup.status'
        db.delete_column(u'operations_sgroup', 'status')

        # Deleting field 'SGroupAuditLogEntry.status'
        db.delete_column(u'operations_sgroupauditlogentry', 'status')
