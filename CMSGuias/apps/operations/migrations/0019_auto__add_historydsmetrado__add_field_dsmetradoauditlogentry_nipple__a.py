...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoryDSMetrado'
        db.create_table(u'operations_historydsmetrado', (
            ...
            ('qguide', self.gf('django.db.models.fields.FloatField')()),
            ...
            ('nipple', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'operations', ['HistoryDSMetrado'])

        # Adding field 'DSMetradoAuditLogEntry.nipple'
        db.add_column(u'operations_dsmetradoauditlogentry', 'nipple',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DSMetrado.nipple'
        db.add_column(u'operations_dsmetrado', 'nipple',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'MMetrado.nipple'
        db.add_column(u'operations_mmetrado', 'nipple',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'HistoryDSMetrado'
        db.delete_table(u'operations_historydsmetrado')

        # Deleting field 'DSMetradoAuditLogEntry.nipple'
        db.delete_column(u'operations_dsmetradoauditlogentry', 'nipple')

        # Deleting field 'DSMetrado.nipple'
        db.delete_column(u'operations_dsmetrado', 'nipple')

        # Deleting field 'MMetrado.nipple'
        db.delete_column(u'operations_mmetrado', 'nipple')
