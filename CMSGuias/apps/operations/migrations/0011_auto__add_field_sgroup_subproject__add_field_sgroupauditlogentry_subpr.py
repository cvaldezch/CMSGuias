...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SGroup.subproject'
        db.add_column(u'operations_sgroup', 'subproject',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Subproyecto'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'SGroupAuditLogEntry.subproject'
        db.add_column(u'operations_sgroupauditlogentry', 'subproject',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Subproyecto'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SGroup.subproject'
        db.delete_column(u'operations_sgroup', 'subproject_id')

        # Deleting field 'SGroupAuditLogEntry.subproject'
        db.delete_column(u'operations_sgroupauditlogentry', 'subproject_id')
