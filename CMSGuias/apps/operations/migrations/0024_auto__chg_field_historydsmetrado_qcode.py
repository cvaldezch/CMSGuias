...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HistoryDSMetrado.qcode'
        db.alter_column(u'operations_historydsmetrado', 'qcode', self.gf('django.db.models.fields.CharField')(max_length=6))

    def backwards(self, orm):

        # Changing field 'HistoryDSMetrado.qcode'
        db.alter_column(u'operations_historydsmetrado', 'qcode', self.gf('django.db.models.fields.CharField')(max_length=16))
