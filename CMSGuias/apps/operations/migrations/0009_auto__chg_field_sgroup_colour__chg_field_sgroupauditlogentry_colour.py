...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SGroup.colour'
        db.alter_column(u'operations_sgroup', 'colour', self.gf('django.db.models.fields.CharField')(max_length=21, null=True))

        # Changing field 'SGroupAuditLogEntry.colour'
        db.alter_column(u'operations_sgroupauditlogentry', 'colour', self.gf('django.db.models.fields.CharField')(max_length=21, null=True))

    def backwards(self, orm):

        # Changing field 'SGroup.colour'
        db.alter_column(u'operations_sgroup', 'colour', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))

        # Changing field 'SGroupAuditLogEntry.colour'
        db.alter_column(u'operations_sgroupauditlogentry', 'colour', self.gf('django.db.models.fields.CharField')(max_length=7, null=True))
