...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SGroup.register'
        db.alter_column(u'operations_sgroup', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'SGroupAuditLogEntry.register'
        db.alter_column(u'operations_sgroupauditlogentry', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'SGroup.register'
        db.alter_column(u'operations_sgroup', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'SGroupAuditLogEntry.register'
        db.alter_column(u'operations_sgroupauditlogentry', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
