...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'operations_sgroup', (
            ...
            ('sgroup_id', self.gf('django.db.models.fields.CharField')(default='SG0000', max_length=6)),
    ...
    models = {
        ...
        u'operations.sgroup': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'sector': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Sectore']"}),
            'sgroup_id': ('django.db.models.fields.CharField', [], {'default': "'SG0000'", 'max_length': '6'})
        },
        u'ventas.proyecto': {
