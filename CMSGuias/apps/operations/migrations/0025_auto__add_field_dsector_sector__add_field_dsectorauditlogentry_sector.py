...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DSector.sector'
        db.add_column(u'operations_dsector', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'DSectorAuditLogEntry.sector'
        db.add_column(u'operations_dsectorauditlogentry', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DSector.sector'
        db.delete_column(u'operations_dsector', 'sector_id')

        # Deleting field 'DSectorAuditLogEntry.sector'
        db.delete_column(u'operations_dsectorauditlogentry', 'sector_id')
