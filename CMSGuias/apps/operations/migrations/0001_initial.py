...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetProject'
        db.create_table(u'operations_metproject', (
            ...
            ('materiales', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['home.Materiale'])),
            ...
            ('quantityorder', self.gf('django.db.models.fields.FloatField')(default=0)),
        ...
        db.send_create_signal(u'operations', ['MetProject'])

        # Adding model 'Nipple'
        db.create_table(u'operations_nipple', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'operations', ['Nipple'])

        # Adding model 'Deductive'
        db.create_table(u'operations_deductive', (
            ('deductive_id', self.gf('django.db.models.fields.CharField')(max_length=10, primary_key=True)),
            ('proyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'])),
            ('subproyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Subproyecto'], null=True, blank=True)),
            ('sector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True, blank=True)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('rtype', self.gf('django.db.models.fields.CharField')(default='NN', max_length=3)),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('relations', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'operations', ['Deductive'])

        # Adding model 'DeductiveInputs'
        db.create_table(u'operations_deductiveinputs', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deductive', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.Deductive'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ...
            ('related', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal(u'operations', ['DeductiveInputs'])

        # Adding model 'DeductiveOutputs'
        db.create_table(u'operations_deductiveoutputs', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deductive', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.Deductive'])),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('materials', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
        ...
        db.send_create_signal(u'operations', ['DeductiveOutputs'])

        # Adding model 'LetterAuditLogEntry'
        db.create_table(u'operations_letterauditlogentry', (
            ('letter_id', self.gf('django.db.models.fields.CharField')(max_length=19, db_index=True)),
            ...
            ('froms', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('fors', self.gf('django.db.models.fields.CharField')(max_length=80)),
            ('status', self.gf('django.db.models.fields.CharField')(default='PE', max_length=2)),
            ('letter', self.gf('django.db.models.fields.files.FileField')(max_length=200, null=True, blank=True)),
            ('observation', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_letter_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'operations', ['LetterAuditLogEntry'])

        # Adding model 'Letter'
        db.create_table(u'operations_letter', (
            ('letter_id', self.gf('django.db.models.fields.CharField')(max_length=19, primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'])),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('performed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'])),
            ('froms', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ...
        db.send_create_signal(u'operations', ['Letter'])

        # Adding model 'LetterAnexoAuditLogEntry'
        db.create_table(u'operations_letteranexoauditlogentry', (
            (u'id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ('letter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.Letter'])),
            ('anexo', self.gf('django.db.models.fields.files.FileField')(max_length=200, null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_letteranexo_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'operations', ['LetterAnexoAuditLogEntry'])

        # Adding model 'LetterAnexo'
        db.create_table(u'operations_letteranexo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('letter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.Letter'])),
            ('anexo', self.gf('django.db.models.fields.files.FileField')(max_length=200, null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'operations', ['LetterAnexo'])

        # Adding model 'PreOrders'
        db.create_table(u'operations_preorders', (
            ('preorder_id', self.gf('django.db.models.fields.CharField')(max_length=10, primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'])),
            ('subproject', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Subproyecto'], null=True, blank=True)),
            ('sector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True, blank=True)),
            ('performed', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'])),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('transfer', self.gf('django.db.models.fields.DateField')()),
            ('issue', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('observation', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('nipples', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('annular', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='PE', max_length=2)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'operations', ['PreOrders'])

        # Adding model 'DetailsPreOrders'
        db.create_table(u'operations_detailspreorders', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('preorder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.PreOrders'])),
            ('materials', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
            ...
            ('orders', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'operations', ['DetailsPreOrders'])


    def backwards(self, orm):
        # Deleting model 'MetProject'
        db.delete_table(u'operations_metproject')

        # Deleting model 'Nipple'
        db.delete_table(u'operations_nipple')

        # Deleting model 'Deductive'
        db.delete_table(u'operations_deductive')

        # Deleting model 'DeductiveInputs'
        db.delete_table(u'operations_deductiveinputs')

        # Deleting model 'DeductiveOutputs'
        db.delete_table(u'operations_deductiveoutputs')

        # Deleting model 'LetterAuditLogEntry'
        db.delete_table(u'operations_letterauditlogentry')

        # Deleting model 'Letter'
        db.delete_table(u'operations_letter')

        # Deleting model 'LetterAnexoAuditLogEntry'
        db.delete_table(u'operations_letteranexoauditlogentry')

        # Deleting model 'LetterAnexo'
        db.delete_table(u'operations_letteranexo')

        # Deleting model 'PreOrders'
        db.delete_table(u'operations_preorders')

        # Deleting model 'DetailsPreOrders'
        db.delete_table(u'operations_detailspreorders')
