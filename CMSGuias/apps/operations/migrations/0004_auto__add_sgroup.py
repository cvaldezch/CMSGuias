...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SGroup'
        db.create_table(u'operations_sgroup', (
            ('sgroup_id', self.gf('django.db.models.fields.CharField')(default='SG0000', max_length=6, primary_key=True)),
        ...
        db.send_create_signal(u'operations', ['SGroup'])


    def backwards(self, orm):
        # Deleting model 'SGroup'
        db.delete_table(u'operations_sgroup')
