...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DSMetradoAuditLogEntry.comment'
        db.alter_column(u'operations_dsmetradoauditlogentry', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'DSMetrado.comment'
        db.alter_column(u'operations_dsmetrado', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'MMetrado.comment'
        db.alter_column(u'operations_mmetrado', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'DSMetradoAuditLogEntry.comment'
        db.alter_column(u'operations_dsmetradoauditlogentry', 'comment', self.gf('django.db.models.fields.TextField')(default=2))

        # Changing field 'DSMetrado.comment'
        db.alter_column(u'operations_dsmetrado', 'comment', self.gf('django.db.models.fields.TextField')(default=2))

        # Changing field 'MMetrado.comment'
        db.alter_column(u'operations_mmetrado', 'comment', self.gf('django.db.models.fields.TextField')(default=2))
