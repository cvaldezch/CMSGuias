...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DSector'
        db.create_table(u'operations_dsector', (
            ('dsector_id', self.gf('django.db.models.fields.CharField')(default='SG0000DS000', max_length=11, primary_key=True)),
        ...
        db.send_create_signal(u'operations', ['DSector'])


    def backwards(self, orm):
        # Deleting model 'DSector'
        db.delete_table(u'operations_dsector')
