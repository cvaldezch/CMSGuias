...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DSector.plane'
        db.alter_column(u'operations_dsector', 'plane', self.gf('django.db.models.fields.files.FileField')(max_length=200, null=True))

        # Changing field 'DSectorAuditLogEntry.plane'
        db.alter_column(u'operations_dsectorauditlogentry', 'plane', self.gf('django.db.models.fields.files.FileField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'DSector.plane'
        db.alter_column(u'operations_dsector', 'plane', self.gf('django.db.models.fields.files.FileField')(default=3, max_length=200))

        # Changing field 'DSectorAuditLogEntry.plane'
        db.alter_column(u'operations_dsectorauditlogentry', 'plane', self.gf('django.db.models.fields.files.FileField')(default=3, max_length=200))
