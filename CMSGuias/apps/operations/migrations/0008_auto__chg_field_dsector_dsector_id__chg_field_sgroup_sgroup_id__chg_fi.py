...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DSector.dsector_id'
        db.alter_column(u'operations_dsector', 'dsector_id', self.gf('django.db.models.fields.CharField')(max_length=18, primary_key=True))

        # Changing field 'SGroup.sgroup_id'
        db.alter_column(u'operations_sgroup', 'sgroup_id', self.gf('django.db.models.fields.CharField')(max_length=11, primary_key=True))

        # Changing field 'DSectorAuditLogEntry.dsector_id'
        db.alter_column(u'operations_dsectorauditlogentry', 'dsector_id', self.gf('django.db.models.fields.CharField')(max_length=18))

        # Changing field 'SGroupAuditLogEntry.sgroup_id'
        db.alter_column(u'operations_sgroupauditlogentry', 'sgroup_id', self.gf('django.db.models.fields.CharField')(max_length=11))

    def backwards(self, orm):

        # Changing field 'DSector.dsector_id'
        db.alter_column(u'operations_dsector', 'dsector_id', self.gf('django.db.models.fields.CharField')(max_length=11, primary_key=True))

        # Changing field 'SGroup.sgroup_id'
        db.alter_column(u'operations_sgroup', 'sgroup_id', self.gf('django.db.models.fields.CharField')(max_length=6, primary_key=True))

        # Changing field 'DSectorAuditLogEntry.dsector_id'
        db.alter_column(u'operations_dsectorauditlogentry', 'dsector_id', self.gf('django.db.models.fields.CharField')(max_length=11))

        # Changing field 'SGroupAuditLogEntry.sgroup_id'
        db.alter_column(u'operations_sgroupauditlogentry', 'sgroup_id', self.gf('django.db.models.fields.CharField')(max_length=6))
    ...
    models = {
        ...
        u'operations.sgroup': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'sector': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Sectore']"}),
            'sgroup_id': ('django.db.models.fields.CharField', [], {'default': "'PRAA000SG0000'", 'max_length': '11', 'primary_key': 'True'})
        },
        u'operations.sgroupauditlogentry': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'sector': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Sectore']"}),
            'sgroup_id': ('django.db.models.fields.CharField', [], {'default': "'PRAA000SG0000'", 'max_length': '11', 'db_index': 'True'})
        },
