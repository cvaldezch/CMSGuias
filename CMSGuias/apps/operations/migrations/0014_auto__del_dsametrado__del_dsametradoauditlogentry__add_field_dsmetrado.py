...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DSMetrado.qguide'
        db.add_column(u'operations_dsmetrado', 'qguide',
                      self.gf('django.db.models.fields.FloatField')(default=2),
                      keep_default=False)

        # Adding field 'DSMetrado.flag'
        db.add_column(u'operations_dsmetrado', 'flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'DSMetrado.tag'
        db.alter_column(u'operations_dsmetrado', 'tag', self.gf('django.db.models.fields.CharField')(max_length=1))
        # Adding field 'DSMetradoAuditLogEntry.qguide'
        db.add_column(u'operations_dsmetradoauditlogentry', 'qguide',
                      self.gf('django.db.models.fields.FloatField')(default=2),
                      keep_default=False)

        # Adding field 'DSMetradoAuditLogEntry.flag'
        db.add_column(u'operations_dsmetradoauditlogentry', 'flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'DSMetradoAuditLogEntry.tag'
        db.alter_column(u'operations_dsmetradoauditlogentry', 'tag', self.gf('django.db.models.fields.CharField')(max_length=1))
        # Adding field 'MMetrado.qguide'
        db.add_column(u'operations_mmetrado', 'qguide',
                      self.gf('django.db.models.fields.FloatField')(default=3),
                      keep_default=False)

        # Adding field 'MMetrado.flag'
        db.add_column(u'operations_mmetrado', 'flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'MMetrado.tag'
        db.alter_column(u'operations_mmetrado', 'tag', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DSMetrado.qguide'
        db.delete_column(u'operations_dsmetrado', 'qguide')

        # Deleting field 'DSMetrado.flag'
        db.delete_column(u'operations_dsmetrado', 'flag')


        # Changing field 'DSMetrado.tag'
        db.alter_column(u'operations_dsmetrado', 'tag', self.gf('django.db.models.fields.BooleanField')())
        # Deleting field 'DSMetradoAuditLogEntry.qguide'
        db.delete_column(u'operations_dsmetradoauditlogentry', 'qguide')

        # Deleting field 'DSMetradoAuditLogEntry.flag'
        db.delete_column(u'operations_dsmetradoauditlogentry', 'flag')


        # Changing field 'DSMetradoAuditLogEntry.tag'
        db.alter_column(u'operations_dsmetradoauditlogentry', 'tag', self.gf('django.db.models.fields.BooleanField')())
        # Deleting field 'MMetrado.qguide'
        db.delete_column(u'operations_mmetrado', 'qguide')

        # Deleting field 'MMetrado.flag'
        db.delete_column(u'operations_mmetrado', 'flag')


        # Changing field 'MMetrado.tag'
        db.alter_column(u'operations_mmetrado', 'tag', self.gf('django.db.models.fields.BooleanField')())
