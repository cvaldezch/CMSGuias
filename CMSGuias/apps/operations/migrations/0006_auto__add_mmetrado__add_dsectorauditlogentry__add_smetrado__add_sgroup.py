...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MMetrado'
        db.create_table(u'operations_mmetrado', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('qcode', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ...
        db.send_create_signal(u'operations', ['MMetrado'])

        # Adding model 'DSectorAuditLogEntry'
        db.create_table(u'operations_dsectorauditlogentry', (
            ('dsector_id', self.gf('django.db.models.fields.CharField')(default='SG0000DS000', max_length=11, db_index=True)),
            ('sgroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.SGroup'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('plane', self.gf('django.db.models.fields.files.FileField')(max_length=200)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('datestart', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_dsector_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'operations', ['DSectorAuditLogEntry'])
        ...
        # Adding model 'SGroupAuditLogEntry'
        db.create_table(u'operations_sgroupauditlogentry', (
            ('sgroup_id', self.gf('django.db.models.fields.CharField')(default='SG0000', max_length=6, db_index=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'])),
            ...
            ('observation', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_sgroup_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'operations', ['SGroupAuditLogEntry'])
    ...
    def backwards(self, orm):
        # Deleting model 'MMetrado'
        db.delete_table(u'operations_mmetrado')

        # Deleting model 'DSectorAuditLogEntry'
        db.delete_table(u'operations_dsectorauditlogentry')

        # Deleting model 'SMetrado'
        db.delete_table(u'operations_smetrado')

        # Deleting model 'SGroupAuditLogEntry'
        db.delete_table(u'operations_sgroupauditlogentry')
    ...
    models = {
        ...
        u'operations.dsector': {
            ...
            'dsector_id': ('django.db.models.fields.CharField', [], {'default': "'SG0000DS000'", 'max_length': '11', 'primary_key': 'True'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'observation': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'plane': ('django.db.models.fields.files.FileField', [], {'max_length': '200'}),
        ...
        u'operations.dsectorauditlogentry': {
            ...
            'datestart': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'dsector_id': ('django.db.models.fields.CharField', [], {'default': "'SG0000DS000'", 'max_length': '11', 'db_index': 'True'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'observation': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'plane': ('django.db.models.fields.files.FileField', [], {'max_length': '200'}),
        ...
        u'operations.sgroup': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'sector': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Sectore']"}),
            'sgroup_id': ('django.db.models.fields.CharField', [], {'default': "'SG0000'", 'max_length': '6', 'primary_key': 'True'})
        },
        u'operations.sgroupauditlogentry': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'sector': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Sectore']"}),
            'sgroup_id': ('django.db.models.fields.CharField', [], {'default': "'SG0000'", 'max_length': '6', 'db_index': 'True'})
        },
        u'operations.smetrado': {
            'Meta': {'object_name': 'SMetrado'},
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Brand']"}),
            'comment': ('django.db.models.fields.TextField', [], {}),
            'dsector_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['operations.DSector']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'operations.smetradoauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'SMetradoAuditLogEntry'},
            u'action_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_smetrado_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Brand']"}),
            'comment': ('django.db.models.fields.TextField', [], {}),
            'dsector_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['operations.DSector']"}),
            u'id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'blank': 'True'}),
