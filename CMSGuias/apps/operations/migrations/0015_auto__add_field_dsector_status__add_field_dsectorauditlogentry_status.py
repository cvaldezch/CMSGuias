...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DSector.status'
        db.add_column(u'operations_dsector', 'status',
                      self.gf('django.db.models.fields.CharField')(default='PE', max_length=2),
                      keep_default=False)

        # Adding field 'DSectorAuditLogEntry.status'
        db.add_column(u'operations_dsectorauditlogentry', 'status',
                      self.gf('django.db.models.fields.CharField')(default='PE', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DSector.status'
        db.delete_column(u'operations_dsector', 'status')

        # Deleting field 'DSectorAuditLogEntry.status'
        db.delete_column(u'operations_dsectorauditlogentry', 'status')
