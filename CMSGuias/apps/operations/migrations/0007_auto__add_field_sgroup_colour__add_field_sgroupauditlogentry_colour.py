...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SGroup.colour'
        db.add_column(u'operations_sgroup', 'colour',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)

        # Adding field 'SGroupAuditLogEntry.colour'
        db.add_column(u'operations_sgroupauditlogentry', 'colour',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SGroup.colour'
        db.delete_column(u'operations_sgroup', 'colour')

        # Deleting field 'SGroupAuditLogEntry.colour'
        db.delete_column(u'operations_sgroupauditlogentry', 'colour')
