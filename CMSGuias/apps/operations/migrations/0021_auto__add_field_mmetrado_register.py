...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MMetrado.register'
        db.add_column(u'operations_mmetrado', 'register',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MMetrado.register'
        db.delete_column(u'operations_mmetrado', 'register')
