...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MMetrado.qcode'
        db.delete_column(u'operations_mmetrado', 'qcode')


    def backwards(self, orm):
        # Adding field 'MMetrado.qcode'
        db.add_column(u'operations_mmetrado', 'qcode',
                      self.gf('django.db.models.fields.CharField')(default=2, max_length=16),
                      keep_default=False)
