...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'operations_dsector', 'dsector_id', self.gf('django.db.models.fields.CharField')(max_length=23, primary_key=True))

        # Changing field 'DSectorAuditLogEntry.dsector_id'
        db.alter_column(u'operations_dsectorauditlogentry', 'dsector_id', self.gf('django.db.models.fields.CharField')(max_length=23))
        # Adding field 'DSMetradoAuditLogEntry.sector'
        db.add_column(u'operations_dsmetradoauditlogentry', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True),
                      keep_default=False)

        # Adding field 'DSMetrado.sector'
        db.add_column(u'operations_dsmetrado', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True),
                      keep_default=False)

        # Adding field 'MMetrado.sector'
        db.add_column(u'operations_mmetrado', 'sector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Sectore'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DSMetradoAuditLogEntry.sector'
        db.delete_column(u'operations_dsmetradoauditlogentry', 'sector_id')

        # Deleting field 'DSMetrado.sector'
        db.delete_column(u'operations_dsmetrado', 'sector_id')

        # Deleting field 'MMetrado.sector'
        db.delete_column(u'operations_mmetrado', 'sector_id')
