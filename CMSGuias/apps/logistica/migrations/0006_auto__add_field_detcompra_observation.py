...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetCompra.observation'
        db.add_column(u'logistica_detcompra', 'observation',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetCompra.observation'
        db.delete_column(u'logistica_detcompra', 'observation')
