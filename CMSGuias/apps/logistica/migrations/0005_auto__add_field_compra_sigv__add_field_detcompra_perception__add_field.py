...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compra.sigv'
        db.add_column(u'logistica_compra', 'sigv',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'DetCompra.perception'
        db.add_column(u'logistica_detcompra', 'perception',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'ServiceOrder.sigv'
        db.add_column(u'logistica_serviceorder', 'sigv',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compra.sigv'
        db.delete_column(u'logistica_compra', 'sigv')

        # Deleting field 'DetCompra.perception'
        db.delete_column(u'logistica_detcompra', 'perception')

        # Deleting field 'ServiceOrder.sigv'
        db.delete_column(u'logistica_serviceorder', 'sigv')
