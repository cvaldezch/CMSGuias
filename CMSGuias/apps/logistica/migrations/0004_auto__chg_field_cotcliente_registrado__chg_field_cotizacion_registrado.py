...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CotCliente.registrado'
        db.alter_column(u'logistica_cotcliente', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Cotizacion.registrado'
        db.alter_column(u'logistica_cotizacion', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ServiceOrder.register'
        db.alter_column(u'logistica_serviceorder', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'CotCliente.registrado'
        db.alter_column(u'logistica_cotcliente', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Cotizacion.registrado'
        db.alter_column(u'logistica_cotizacion', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ServiceOrder.register'
        db.alter_column(u'logistica_serviceorder', 'register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
