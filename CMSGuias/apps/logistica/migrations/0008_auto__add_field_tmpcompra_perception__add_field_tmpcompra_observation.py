...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'tmpcompra.perception'
        db.add_column(u'logistica_tmpcompra', 'perception',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'tmpcompra.observation'
        db.add_column(u'logistica_tmpcompra', 'observation',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'tmpcompra.perception'
        db.delete_column(u'logistica_tmpcompra', 'perception')

        # Deleting field 'tmpcompra.observation'
        db.delete_column(u'logistica_tmpcompra', 'observation')
