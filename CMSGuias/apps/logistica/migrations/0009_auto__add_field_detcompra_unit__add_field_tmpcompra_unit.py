...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetCompra.unit'
        db.add_column(u'logistica_detcompra', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Unidade'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'tmpcompra.unit'
        db.add_column(u'logistica_tmpcompra', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Unidade'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetCompra.unit'
        db.delete_column(u'logistica_detcompra', 'unit_id')

        # Deleting field 'tmpcompra.unit'
        db.delete_column(u'logistica_tmpcompra', 'unit_id')
    ...
    models = {
        ...
        u'logistica.compra': {
            ...
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'freight': ('django.db.models.fields.FloatField', [], {'default': '0', 'blank': 'True'}),
