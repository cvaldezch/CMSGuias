...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Compra.freight'
        db.add_column(u'logistica_compra', 'freight',
                      self.gf('django.db.models.fields.FloatField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Compra.paid'
        db.add_column(u'logistica_compra', 'paid',
                      self.gf('django.db.models.fields.CharField')(default='0', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Compra.freight'
        db.delete_column(u'logistica_compra', 'freight')

        # Deleting field 'Compra.paid'
        db.delete_column(u'logistica_compra', 'paid')
