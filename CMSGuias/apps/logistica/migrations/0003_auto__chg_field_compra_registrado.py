...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Compra.registrado'
        db.alter_column(u'logistica_compra', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Compra.registrado'
        db.alter_column(u'logistica_compra', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
