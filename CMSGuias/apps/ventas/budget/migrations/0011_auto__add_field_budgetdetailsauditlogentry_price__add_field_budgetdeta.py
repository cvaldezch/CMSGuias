...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BudgetDetailsAuditLogEntry.price'
        db.add_column(u'budget_budgetdetailsauditlogentry', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=3),
                      keep_default=False)

        # Adding field 'BudgetDetailsAuditLogEntry.discount'
        db.add_column(u'budget_budgetdetailsauditlogentry', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=3, decimal_places=2),
                      keep_default=False)

        # Adding field 'BudgetDetails.price'
        db.add_column(u'budget_budgetdetails', 'price',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=3),
                      keep_default=False)

        # Adding field 'BudgetDetails.discount'
        db.add_column(u'budget_budgetdetails', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=3, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BudgetDetailsAuditLogEntry.price'
        db.delete_column(u'budget_budgetdetailsauditlogentry', 'price')

        # Deleting field 'BudgetDetailsAuditLogEntry.discount'
        db.delete_column(u'budget_budgetdetailsauditlogentry', 'discount')

        # Deleting field 'BudgetDetails.price'
        db.delete_column(u'budget_budgetdetails', 'price')

        # Deleting field 'BudgetDetails.discount'
        db.delete_column(u'budget_budgetdetails', 'discount')
    ...
    models = {
        ...
        u'budget.analysis': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
