...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'BudgetDetailsAuditLogEntry.budgetsub'
        raise RuntimeError("Cannot reverse this migration. 'BudgetDetailsAuditLogEntry.budgetsub' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BudgetDetailsAuditLogEntry.budgetsub'
        db.alter_column(u'budget_budgetdetailsauditlogentry', 'budgetsub_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['budget.BudgetSub']))

        # User chose to not deal with backwards NULL issues for 'BudgetDetails.budgetsub'
        raise RuntimeError("Cannot reverse this migration. 'BudgetDetails.budgetsub' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'BudgetDetails.budgetsub'
        db.alter_column(u'budget_budgetdetails', 'budgetsub_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['budget.BudgetSub']))
    ...
    models = {
        ...
        u'budget.analysis': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 13, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
