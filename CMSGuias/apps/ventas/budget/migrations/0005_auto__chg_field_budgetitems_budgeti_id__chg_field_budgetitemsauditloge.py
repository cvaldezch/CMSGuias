...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BudgetItems.budgeti_id'
        db.alter_column(u'budget_budgetitems', 'budgeti_id', self.gf('django.db.models.fields.CharField')(max_length=15, primary_key=True))

        # Changing field 'BudgetItemsAuditLogEntry.budgeti_id'
        db.alter_column(u'budget_budgetitemsauditlogentry', 'budgeti_id', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'BudgetItems.budgeti_id'
        db.alter_column(u'budget_budgetitems', 'budgeti_id', self.gf('django.db.models.fields.CharField')(max_length=13, primary_key=True))

        # Changing field 'BudgetItemsAuditLogEntry.budgeti_id'
        db.alter_column(u'budget_budgetitemsauditlogentry', 'budgeti_id', self.gf('django.db.models.fields.CharField')(max_length=13))
    ...
    models = {
        ...
        u'budget.analysis': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        u'budget.budgetitems': {
            ...
            'base': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'budget': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['budget.Budget']"}),
            'budgeti_id': ('django.db.models.fields.CharField', [], {'max_length': '15', 'primary_key': 'True'}),
        ...
        u'budget.budgetitemsauditlogentry': {
            ...
            'base': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'budget': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['budget.Budget']"}),
            'budgeti_id': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
            'item': ('django.db.models.fields.IntegerField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'offer': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
