...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BudgetItems.item'
        db.alter_column(u'budget_budgetitems', 'item', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'BudgetItemsAuditLogEntry.item'
        db.alter_column(u'budget_budgetitemsauditlogentry', 'item', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'BudgetItems.item'
        db.alter_column(u'budget_budgetitems', 'item', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'BudgetItemsAuditLogEntry.item'
        db.alter_column(u'budget_budgetitemsauditlogentry', 'item', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'budget.budgetitems': {
            ...
            'item': ('django.db.models.fields.DecimalField', [], {'max_digits': '3', 'decimal_places': '2'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'offer': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
