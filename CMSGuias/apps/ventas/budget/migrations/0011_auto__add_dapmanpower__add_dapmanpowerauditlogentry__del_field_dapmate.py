...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DAPMaterials.danalysis'
        db.delete_column(u'budget_dapmaterials', 'danalysis_id')

        # Adding field 'DAPMaterials.adetails'
        db.add_column(u'budget_dapmaterials', 'adetails',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['budget.AnalysisDetails']),
                      keep_default=False)

        # Deleting field 'DAPMaterialsAuditLogEntry.danalysis'
        db.delete_column(u'budget_dapmaterialsauditlogentry', 'danalysis_id')

        # Adding field 'DAPMaterialsAuditLogEntry.adetails'
        db.add_column(u'budget_dapmaterialsauditlogentry', 'adetails',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['budget.AnalysisDetails']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'DAPMaterials.danalysis'
        db.add_column(u'budget_dapmaterials', 'danalysis',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['budget.AnalysisDetails']),
                      keep_default=False)

        # Deleting field 'DAPMaterials.adetails'
        db.delete_column(u'budget_dapmaterials', 'adetails_id')

        # Adding field 'DAPMaterialsAuditLogEntry.danalysis'
        db.add_column(u'budget_dapmaterialsauditlogentry', 'danalysis',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['budget.AnalysisDetails']),
                      keep_default=False)

        # Deleting field 'DAPMaterialsAuditLogEntry.adetails'
        db.delete_column(u'budget_dapmaterialsauditlogentry', 'adetails_id')
