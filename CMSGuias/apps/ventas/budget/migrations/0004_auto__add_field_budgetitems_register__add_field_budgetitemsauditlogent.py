...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BudgetItems.register'
        db.add_column(u'budget_budgetitems', 'register',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BudgetItemsAuditLogEntry.register'
        db.add_column(u'budget_budgetitemsauditlogentry', 'register',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BudgetItems.register'
        db.delete_column(u'budget_budgetitems', 'register')

        # Deleting field 'BudgetItemsAuditLogEntry.register'
        db.delete_column(u'budget_budgetitemsauditlogentry', 'register')
    ...
    models = {
        ...
        u'budget.analysis': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 24, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
