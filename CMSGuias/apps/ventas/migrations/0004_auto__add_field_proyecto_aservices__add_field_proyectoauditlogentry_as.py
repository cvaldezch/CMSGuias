...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proyecto.aservices'
        db.add_column(u'ventas_proyecto', 'aservices',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3, blank=True),
                      keep_default=False)

        # Adding field 'ProyectoAuditLogEntry.aservices'
        db.add_column(u'ventas_proyectoauditlogentry', 'aservices',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=9, decimal_places=3, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proyecto.aservices'
        db.delete_column(u'ventas_proyecto', 'aservices')

        # Deleting field 'ProyectoAuditLogEntry.aservices'
        db.delete_column(u'ventas_proyectoauditlogentry', 'aservices')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'L58X7I'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'AAZR2L'", 'max_length': '6'})
        },
        u'ventas.sectore': {
