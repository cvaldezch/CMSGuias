...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HistoryMetProject.date'
        db.alter_column(u'ventas_historymetproject', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'TDDG73'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'0KGZYC'", 'max_length': '6'})
        },
        u'ventas.sectore': {
        ...
        u'ventas.sectorfiles': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 9, 17, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            ...
            'sector': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Sectore']"}),
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.time(16, 2, 50, 638181)', 'auto_now': 'True', 'blank': 'True'})
        },
