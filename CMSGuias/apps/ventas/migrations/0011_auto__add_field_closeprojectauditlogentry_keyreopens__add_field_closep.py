...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloseProjectAuditLogEntry.keyreopens'
        db.add_column(u'ventas_closeprojectauditlogentry', 'keyreopens',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True),
                      keep_default=False)

        # Adding field 'CloseProjectAuditLogEntry.performedre'
        db.add_column(u'ventas_closeprojectauditlogentry', 'performedre',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_reopen', null=True, to=orm['home.Employee']),
                      keep_default=False)

        # Adding field 'CloseProjectAuditLogEntry.datereopen'
        db.add_column(u'ventas_closeprojectauditlogentry', 'datereopen',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'CloseProject.keyreopens'
        db.add_column(u'ventas_closeproject', 'keyreopens',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True),
                      keep_default=False)

        # Adding field 'CloseProject.performedre'
        db.add_column(u'ventas_closeproject', 'performedre',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'reopen', null=True, to=orm['home.Employee']),
                      keep_default=False)

        # Adding field 'CloseProject.datereopen'
        db.add_column(u'ventas_closeproject', 'datereopen',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CloseProjectAuditLogEntry.keyreopens'
        db.delete_column(u'ventas_closeprojectauditlogentry', 'keyreopens')

        # Deleting field 'CloseProjectAuditLogEntry.performedre'
        db.delete_column(u'ventas_closeprojectauditlogentry', 'performedre_id')

        # Deleting field 'CloseProjectAuditLogEntry.datereopen'
        db.delete_column(u'ventas_closeprojectauditlogentry', 'datereopen')

        # Deleting field 'CloseProject.keyreopens'
        db.delete_column(u'ventas_closeproject', 'keyreopens')

        # Deleting field 'CloseProject.performedre'
        db.delete_column(u'ventas_closeproject', 'performedre_id')

        # Deleting field 'CloseProject.datereopen'
        db.delete_column(u'ventas_closeproject', 'datereopen')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'5X1R7T'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'3H9B05'", 'max_length': '6'})
        },
        u'ventas.sectore': {
