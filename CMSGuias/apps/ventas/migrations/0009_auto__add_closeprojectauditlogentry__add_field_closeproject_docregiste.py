...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CloseProjectAuditLogEntry'
        db.create_table(u'ventas_closeprojectauditlogentry', (
            ...
            ('datestorage', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ...
            ('docregister', self.gf('django.db.models.fields.DateField')(null=True)),
            ...
            ('closeconfirm', self.gf('django.db.models.fields.CharField')(default=u'', max_length=6, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default=u'PE', max_length=2, blank=True)),
            ('performedstorage', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'_auditlog_storage', null=True, to=orm['home.Employee'])),
            ('performedoperations', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'_auditlog_operations', null=True, to=orm['home.Employee'])),
            ('performeddocument', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'_auditlog_documents', null=True, to=orm['home.Employee'])),
            ('performedaccounting', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'_auditlog_accounting', null=True, to=orm['home.Employee'])),
            ('performedclose', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'_auditlog_closeasproject', null=True, to=orm['home.Employee'])),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_closeproject_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'ventas', ['CloseProjectAuditLogEntry'])

        # Adding field 'CloseProject.docregister'
        db.add_column(u'ventas_closeproject', 'docregister',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CloseProjectAuditLogEntry'
        db.delete_table(u'ventas_closeprojectauditlogentry')

        # Deleting field 'CloseProject.docregister'
        db.delete_column(u'ventas_closeproject', 'docregister')
    ...
    models = {
        ...
        u'ventas.closeproject': {
            ...
            'docregister': ('django.db.models.fields.DateField', [], {'null': 'True'}),
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'ZGTPBH'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'Z5YIGB'", 'max_length': '6'})
        },
        u'ventas.sectore': {
