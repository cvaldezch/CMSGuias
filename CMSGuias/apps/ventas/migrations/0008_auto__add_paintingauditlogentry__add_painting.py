...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PaintingAuditLogEntry'
        db.create_table(u'ventas_paintingauditlogentry', (
            ...
            ('nlayers', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
            ('nfilmb', self.gf('django.db.models.fields.SmallIntegerField')(default=4)),
            ('nfilmc', self.gf('django.db.models.fields.SmallIntegerField')(default=4)),
            ...
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_painting_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'ventas', ['PaintingAuditLogEntry'])

        # Adding model 'Painting'
        db.create_table(u'ventas_painting', (
        ...
        db.send_create_signal(u'ventas', ['Painting'])


    def backwards(self, orm):
        # Deleting model 'PaintingAuditLogEntry'
        db.delete_table(u'ventas_paintingauditlogentry')

        # Deleting model 'Painting'
        db.delete_table(u'ventas_painting')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'RHCCLP'", 'max_length': '6'})
        },
        ...
        u'ventas.painting': {
            'Meta': {'ordering': "['-project']", 'object_name': 'Painting'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'LCIPE2'", 'max_length': '6'})
        },
        u'ventas.sectore': {
