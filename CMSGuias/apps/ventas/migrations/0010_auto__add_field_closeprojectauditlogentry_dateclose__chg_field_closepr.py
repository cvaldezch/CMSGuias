...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CloseProjectAuditLogEntry.dateclose'
        db.add_column(u'ventas_closeprojectauditlogentry', 'dateclose',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'CloseProjectAuditLogEntry.documents'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'documents', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

        # Changing field 'CloseProjectAuditLogEntry.docregister'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'docregister', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CloseProjectAuditLogEntry.datestorage'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'datestorage', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'CloseProjectAuditLogEntry.dateletter'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'dateletter', self.gf('django.db.models.fields.DateTimeField')(null=True))
        # Adding field 'CloseProject.dateclose'
        db.add_column(u'ventas_closeproject', 'dateclose',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


        # Changing field 'CloseProject.documents'
        db.alter_column(u'ventas_closeproject', 'documents', self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True))

        # Changing field 'CloseProject.docregister'
        db.alter_column(u'ventas_closeproject', 'docregister', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CloseProject.datestorage'
        db.alter_column(u'ventas_closeproject', 'datestorage', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'CloseProject.dateletter'
        db.alter_column(u'ventas_closeproject', 'dateletter', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting field 'CloseProjectAuditLogEntry.dateclose'
        db.delete_column(u'ventas_closeprojectauditlogentry', 'dateclose')


        # Changing field 'CloseProjectAuditLogEntry.documents'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'documents', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CloseProjectAuditLogEntry.docregister'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'docregister', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CloseProjectAuditLogEntry.datestorage'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'datestorage', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'CloseProjectAuditLogEntry.dateletter'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'dateletter', self.gf('django.db.models.fields.DateField')(null=True))
        # Deleting field 'CloseProject.dateclose'
        db.delete_column(u'ventas_closeproject', 'dateclose')


        # Changing field 'CloseProject.documents'
        db.alter_column(u'ventas_closeproject', 'documents', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CloseProject.docregister'
        db.alter_column(u'ventas_closeproject', 'docregister', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'CloseProject.datestorage'
        db.alter_column(u'ventas_closeproject', 'datestorage', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'CloseProject.dateletter'
        db.alter_column(u'ventas_closeproject', 'dateletter', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'ventas.closeproject': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "u'PE'", 'max_length': '2', 'blank': 'True'}),
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'H70G6B'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'52K0PT'", 'max_length': '6'})
        },
        u'ventas.sectore': {
