...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RestoreStorage.date'
        db.alter_column(u'ventas_restorestorage', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'HistoryMetProject.date'
        db.alter_column(u'ventas_historymetproject', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Subproyecto.registrado'
        db.alter_column(u'ventas_subproyecto', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Sectore.registrado'
        db.alter_column(u'ventas_sectore', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'SubproyectoAuditLogEntry.registrado'
        db.alter_column(u'ventas_subproyectoauditlogentry', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
        # Adding field 'SectorFiles.dsector'
        db.add_column(u'ventas_sectorfiles', 'dsector',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.DSector'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'CloseProject.datestorage'
        db.alter_column(u'ventas_closeproject', 'datestorage', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'Proyecto.aservices'
        db.alter_column(u'ventas_proyecto', 'aservices', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=3))

        # Changing field 'Proyecto.registrado'
        db.alter_column(u'ventas_proyecto', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'SectoreAuditLogEntry.registrado'
        db.alter_column(u'ventas_sectoreauditlogentry', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProyectoAuditLogEntry.aservices'
        db.alter_column(u'ventas_proyectoauditlogentry', 'aservices', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=3))

        # Changing field 'ProyectoAuditLogEntry.registrado'
        db.alter_column(u'ventas_proyectoauditlogentry', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'RestoreStorage.date'
        db.alter_column(u'ventas_restorestorage', 'date', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'HistoryMetProject.date'
        db.alter_column(u'ventas_historymetproject', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Subproyecto.registrado'
        db.alter_column(u'ventas_subproyecto', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Sectore.registrado'
        db.alter_column(u'ventas_sectore', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'SubproyectoAuditLogEntry.registrado'
        db.alter_column(u'ventas_subproyectoauditlogentry', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
        # Deleting field 'SectorFiles.dsector'
        db.delete_column(u'ventas_sectorfiles', 'dsector_id')


        # Changing field 'CloseProject.datestorage'
        db.alter_column(u'ventas_closeproject', 'datestorage', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Proyecto.aservices'
        db.alter_column(u'ventas_proyecto', 'aservices', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'Proyecto.registrado'
        db.alter_column(u'ventas_proyecto', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'SectoreAuditLogEntry.registrado'
        db.alter_column(u'ventas_sectoreauditlogentry', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ProyectoAuditLogEntry.aservices'
        db.alter_column(u'ventas_proyectoauditlogentry', 'aservices', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=9, decimal_places=3))

        # Changing field 'ProyectoAuditLogEntry.registrado'
        db.alter_column(u'ventas_proyectoauditlogentry', 'registrado', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'ventas.closeproject': {
            ...
            'datestorage': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'R336EE'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'YPHH6E'", 'max_length': '6'})
        },
        u'ventas.sectore': {
